...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<a href="{{ url('pengguna/tambah') }}" class="btn btn-xs btn-pr pull-right">
					...
					<tr>
						...
						<td>
							<div class="btn-group" role="group">
								...
								<a href="{{url('pengguna/lihat/'.$pengguna->id}}" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fa fa-remove"></i></a>
								</div>
						</td>
					</tr>
					@endforeach
